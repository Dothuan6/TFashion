        ...
        <form action="" method="post" enctype="multipart/form-data">
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_title" id="product_title" class="form-control"
                 placeholder="Nhập vào tên sản phẩm..." autocomplete="off"
                 required="required">
            </div>
            ...
            <div class="form-outline mb-4 w-50 m-auto mt-2">
                ...
                <input type="text" name="description" id="description" class="form-control"
                 placeholder="Nhập vào mô tả sản phẩm..." autocomplete="off"
                 required="required">
            </div>
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                <input type="text" name="product_keywords" id="product_keywords" class="form-control"
                 placeholder="Nhập vào từ khóa..." autocomplete="off"
                 required="required">
            </div>
            ...
            <div class="form-outline mb-4 w-50 m-auto">
                ...
                placeholder="Nhập vào giá tiền..." autocomplete="off"
                required="required">
            </div>
